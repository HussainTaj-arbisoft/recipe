...
from recipe.models import User, Recipe, Ingredient, Review
...
def seed_recipe(recipes_count: int = 1000, ingredients_range: (int, int) = (5, 15)):
    ...
    for recipe_number in range(recipes_count):
        ...
        for ingredient_number in range(random.randint(ingredients_range[0], ingredients_range[1])):
        ...
        print(
            f'Progress: {((recipe_number + 1)/recipes_count * 100):.2f}%', end='\r')
    print()
